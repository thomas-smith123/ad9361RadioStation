...
Q_CONSTINIT static const uint qt_meta_data_ZN9board_cfgE[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       8,    0,   47,    2, 0x0a,    6 /* Public */,
       9,    0,   48,    2, 0x0a,    7 /* Public */,
...
Q_CONSTINIT const QMetaObject board_cfg::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9board_cfgE_t,
        ...
        // method 'start_send'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const std::vector<std::complex<int16_t>> &, std::false_type>
    >,
    nullptr
} };
...
void board_cfg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->start_send((*reinterpret_cast< std::add_pointer_t<std::vector<std::complex<int16_t>>>>(_a[1]))); break;
        default: ;
        }
    }
